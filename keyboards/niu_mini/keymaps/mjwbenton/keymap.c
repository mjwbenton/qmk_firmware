...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Alt  | GUI  |  Del |MO(1) |    Space    |MO(2) | Left | Down |  Up  |Right |
   * `-----------------------------------------------------------------------------------'
   */
  [0] = LAYOUT_planck_mit(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_DEL, MO(1),       KC_SPC,       MO(2),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
   ...
   * |------+------+------+------+------+------|------+------+------+------+------+------|
   * |      |RGBtog|RGBmod|RGBhu+|RGBHu-|      |      |      |      |      |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Reset|      |      |      |      |      |      |      | Home |PgDwn | PgUp | End  |
   * `-----------------------------------------------------------------------------------'
   */
  [1] = LAYOUT_planck_mit(
